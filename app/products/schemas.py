...
class IProductFilterParams(BaseModel):
    ...
    brands: Optional[List[str]] = Field(None, description="Список брендов для фильтрации")
    ...
    sort_by: Optional[str] = Field(None, description="Параметр сортировки (price, sort, create_date, id)")
